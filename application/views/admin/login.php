        ...
        <body>
            ...
            <div class=" card-box card_box_custom">
              ...
              <div class="panel-body">
                ...
                <div class="form-group ">
                  <div class="col-xs-12">
                    <input class="form-control name_validation email_validation required_validation_for_login_customer"
                      type="text" name="email" placeholder="Email Address">
                  </div>
                </div>
                <div class="form-group">
                  <div class="col-xs-12">
                    <input class="form-control name_validation required_validation_for_login_customer" type="password"
                ...
                <div class="form-group m-t-30 m-b-0">
                  <div class="col-sm-12">
                    <div style="cursor: pointer;" class="text-dark" data-toggle="modal" data-target="#send"><i
                        class="fa fa-lock m-r-5"></i> Forgot your password?</div>
                  </div>
          ...
          <!---Start Forget -->
          <div id="send" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-12 form-horizontal">
                        <div class="form-group">
                          ...
                          <div class="col-md-9">
                            <input type="text"
                              class="form-control required_validation_for_forget_customer name_validation email_validation"
                              name="checkEmail" placeholder="Enter your email">
                          </div>
                        </div>
                      </div>
                    </div>
          ...
          $(document).ready(function() {
            $(document).on('submit', '#forgetFormDataValue', function(e) {
              ...
              if (check_required_field) {
                ...
                jQuery.ajax({
                  type: "POST",
                  url: "<?php echo base_url(); ?>" + "admin/Login/forgetCheckData",
                  data: formData,
                  success: function(data) {
                    if ($.trim(data) == 'all') {
                      ...
                      $('.setErrorDataValue').html('');
                      $('.setErrorDataValue').html(
                        '<div class="alert alert-danger">Please enter correct email address</div>');
                      window.setTimeout(function() {
                        window.location.href = '<?php echo base_url() ?>';
                      });
