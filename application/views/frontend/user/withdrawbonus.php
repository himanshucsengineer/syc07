<main id="main" class="main">
  ...
  <div class="pagetitle">
    <h1>Withdraw Bonus</h1>
    <nav>
      <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="<?php echo base_url()?>">Home</a></li>
        <li class="breadcrumb-item">user</li>
        <li class="breadcrumb-item active">Withdraw Bonus</li>
      </ol>
    </nav>
  </div><!-- End Page Title -->
  <?php
  ...
  <section class="section">
    <div class="card">
      <div class="card-body">
        <h5 class="card-title">Withdraw Bonus</h5>

        <form action="<?php echo base_url()?>frontend/user/withdrawbonus/transfer" method="post">
