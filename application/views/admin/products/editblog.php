...
<div class="row">
                <div class="col-md-9">
                    <div class="box">
                        ...
                        <input type="text" name="name" placeholder="Enter Heading" required value="<?php echo $value['name']?>">

                        <label>Product Description</label>
                        <textarea name="about" id="textareaContent" placeholder="Type Here...." required><?php echo $value['about']?></textarea>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="box">
                        ...
                        <input type="text" placeholder="Enter Net Weight / Pieces" name="net_content_2" required value="<?php echo $value['net_content_2']?>">
                    ...
                    <div class="box">
                        ...
                        <input type="number" name="original_price" placeholder="Enter Original Price" required value="<?php echo $value['original_price']?>">
                        <label>After Discount Price (INR):</label>
                        <input type="number" name="discounted_price" placeholder="Enter After Discount Price" required value="<?php echo $value['discounted_price']?>">
                    </div>
                </div>
            </div>
