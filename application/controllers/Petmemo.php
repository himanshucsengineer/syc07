...
class Petmemo extends CI_Controller
{
  ...
  public function pay()
  {
    ...
    $this->load->view('petmemopay', array('data' => $data));
  }
  /**
  ...
  public function verify()
  {
    ...
    if ($success === true) {
      ...
      if ($this->Donatemodel->insert_pet_memo_data($data)) {
        $this->session->set_flashdata('success', 'Thank You For Your Donation');
        redirect(base_url() . 'pet-memorial');
      } else {
