...
<head>
  ...
  <link href="<?php echo base_url()?>user/assets/vendor/quill/quill.snow.css" rel="stylesheet">
  <link href="<?php echo base_url()?>user/assets/vendor/quill/quill.bubble.css" rel="stylesheet">
  <link href="<?php echo base_url()?>user/assets/vendor/remixicon/remixicon.css" rel="stylesheet">
  <link href="<?php echo base_url()?>user/assets/vendor/simple-datatables/style.css" rel="stylesheet">
